...
class DestinationScreen extends StatelessWidget {
  ...
  const DestinationScreen({required this.filePath, Key? key}) : super(key: key);
...
class ReceiptWebViewScreenVali extends StatefulWidget {
  ...
  ReceiptWebViewScreenVali({required this.receiptUrl});
    ...
    try {
      ...
      try {
        ...
        await flutterLocalNotificationsPlugin.show(
          0,
          'Download Complete',
          'File saved to Download/Evolvuschool/Parent/receipt/$fileName',
          platformChannelSpecifics,
          payload: path, // Pass the file path as payload
        );
