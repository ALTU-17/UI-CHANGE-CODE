  ...
  Widget _buildSubmitButton() {
      return ElevatedButton(
        onPressed: () async {
          ...
          bool isGuardianDataPartiallyFilled = guardianMobileController.text.isNotEmpty ||
          ...
          if (isGuardianDataPartiallyFilled) {
            ...
            if (guardianMobileController.text.length != 10) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text("Please enter a valid 10-digit guardian mobile number."),
                  backgroundColor: Colors.red,
                ),
              );
              return;
            ...
            if (_guardianImage == null && guardian!.GURimageUrl == "https://via.placeholder.com/100") {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
